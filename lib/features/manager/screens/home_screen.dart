...
class _BranchSelectCard extends StatelessWidget {
  const _BranchSelectCard({
      ...
      children: [
        ...
        HomeTodayWorkersSection(
          ...
          onTapMemo: workerRows.isEmpty
              ? null
              : (row) {
                  final matched = workerRows.firstWhere(
                    (e) => e.time == row.time && e.workerName == row.workerName,
                  );
                  onTapTodayWorkerMemo(matched.row);
                },
          onTapStatus: workerRows.isEmpty
              ...
              : (row) {
                  ...
                  onTapTodayWorkerStatus(matched.row);
                },
        ),
        const SizedBox(height: 28),
        const Divider(height: 1, color: AppColors.grey50),
